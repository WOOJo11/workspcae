...
<head>
    ...
    <title>main</title>
    <link rel="stylesheet" href="/프로젝트/project.css/main.css">
...
<main>
        ...
        <div class="mainView">
            <div class="leftArea">
                <div class="leftArea-1"> 
                    <ul>
                        <li><img src="/images/home.png" alt="home" id="mainHome"><a href="#">홈</a></li>
                        <li><img src="/images/KakaoTalk_20230411_123319455.png" alt="myHome" id="myHome"><a href="#">나의피드</a></li>
                        <li><img src="/images/friends.png" alt="friends" id="friend"><a href="#">친구</a></li>
                        <li><img src="/images/like.png" alt="like" id="likeLogo"><a href="#">내가 저장한 피드</a></li>
                        <li><img src="/images/free-icon-magnifying-glass-4254104.png" alt="search" id="searchLogo"><a href="https://www.naver.com/" target="_blank">초록검색창</a></li>
                    </ul>
                </div>
            ...
            <div class="centerArea"><!--  가운데를 각 needs에 맞춰서 섹터를 나누는게 좋을 것 같아 -->
                <div class="centerArea-1"><!-- 나의 피드 올리기 -->
                    <section id="cArea-1">
                        ...
                        <section>  <a href="#">
                            <img src="/images/KakaoTalk_20230411_123319455.png" alt="로고" id="myLogo">
                        </a>
                    </section>
    ...
    <script src="/프로젝트/project.js/main.js"></script>
