...
public class StudentView {
	...
	private StudentService service = new StudentService(); //import 해야함
	...
	private void selectIndex() {
		...
		//반환 받은 index번째 요소가 null이 아닐 경우 (학생 정보 있을경우)
	...
	private void updateStudent() {
		...
		// 입력 받은 index번째 학생의 정ㅁ수를 수정하는 서비스 호출
		// - 수정 성공시 true / 아니면 false
