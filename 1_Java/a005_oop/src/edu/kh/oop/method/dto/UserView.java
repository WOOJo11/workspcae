...
public class UserView {
	...
	private void signUp() {
		...
		// - 문자열에서 지정된 인데스번째 문자 하나(char)를 변환
		
		// User 객체 주소 또는 null이 반환되어 저장
	...
	private void login() {
		...
		// 입력 받은 값 + singUpUser를 Service의 login 메서드로 전달하여
		// 아이디 비밀번호 일치 시 로그인 
	...
	private void logout() {
		// 로그인 상태인 경우 로그아웃을 수행
		if(UserView.loginUser !=null) { //로그인 상태인경우
