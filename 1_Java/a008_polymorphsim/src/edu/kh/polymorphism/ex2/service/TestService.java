...
public class TestService {
		...
		public void ex1() {
			...
			// animal 객체는 만들 수 없다 but 참조변수의 묶음은 만들 수있다
		...
		public void ex2() {
			//인터페이스
			// 1. 인터페이스는 상수형 필드(static final)만 작성 가능 확인
			// - 인터페이스에 작성했지만 클래스에 작성하는 static 필드와 사용법 동일
			// - 인터페이스필드는 묵시적(암묵적)으로 public static final
			...
			//KH k = new KH(); // 객체 생성은 불가능 하다
			
			// 객체 배열 + 다형성 + 동적 바인딩 
			KH[] arr = new KH[2]; // KH 참조 변수의 묶은 생성
