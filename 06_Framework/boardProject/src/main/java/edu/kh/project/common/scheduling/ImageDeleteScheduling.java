...
public class ImageDeleteScheduling {
	...
	@Autowired BoardService service; // DI (의존성 주입)
	...
	// 대기 10초
	public void test() {
		//System.out.println("스케줄러가 일정시간마다 자동으로 출력");
...
//			System.out.println(server.getName());
			...
			if(dbImageList.indexOf(server.getName())==-1) {
				...
				server.delete(); // File.delete() : 파일삭제
			}
