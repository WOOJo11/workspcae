...
<%-- 
    ...
    (참고) url(Unifrom Resource Locator)
    -> 자원의 위치를 나타내는 문자열 (경로)
...
<body>
    ...
    <a href="loop">JSTL을 이용한 반복분(forEach)</a>
...
<br>
    ...
    - 변수 제거 : 내장 객체에 세팅된 속성을 제거
                (removeAttribute("K"))와 비슷

    - c:remove 속성

    1) var : 삭제할 변수명(속성의 key)
            속성을 제거함 
    ...
    <pre>
    - 변수 출력 \${key} EL 구문과 유사함

    - 단, escapeXml="true"가 기본값이라
    html 태그가 해석되지 않으나 false라면 html 태그 해석 가능
