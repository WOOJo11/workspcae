...
public class ScopeController extends HttpServlet {
		...
		protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
			...
			// 2 . requestScope -> 요청받은 page + 위임받은 page
			req.setAttribute("message", "request scope 저장된 메세지 입니다");
			
			// 3. session scope -> 브라우저 당 1개씩 생성되어 브라우저 종료 또는
			//						session 만료까지 유지
			...
			// 4. application scope -> 서버가 켜져있는동안 유지 
